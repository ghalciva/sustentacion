                  ...
                  <header>
                    ...
                    <table id="tabla">
                        ...
                        <?php
                            ...
                            echo "<td><a href='updateCiudad.php?idciudad=" . $c->getIdciudad() . "&nombre=" . $c->getNombre() ."'> <button class='btn btn-default btn-call-to-action'>Editar</button></a></td>";
                            echo "<td><a href='deleteCiudad.php?idciudad=". $c->getIdciudad() ."'><button class='btn btn-default btn-call-to-action'>Eliminar</button></a></td>";
                            echo "</tr>"; 

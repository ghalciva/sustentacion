                    ...
                    <div class="row">
                      <div class="col-md-10 col-md-offset-1">
                        <div class="block"><center>
                          <form action="saveMuseo.php" method="get">
                              <h1 class="form-group">C R E A R &nbsp;&nbsp;&nbsp; M U S E O</h1>
                                    <div class="form-group">
                                      <input type="text" name="nombre" class="form-control" placeholder="Nombre del museo">
                                    </div>
<div class="form-group">
                                      <input type="text" name="idciudadfk" class="form-control" placeholder="Id de la ciudad">
                                    </div>
